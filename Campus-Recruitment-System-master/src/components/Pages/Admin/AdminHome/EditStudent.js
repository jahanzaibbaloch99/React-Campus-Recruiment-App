...
import { updateDataGet, updateAccount } from '../../../../store/action/index';
...
const EditStudent = (props) => {
  ...
  let editData = useSelector((state) => state.studentReducer.singleData)
  ...
  if (editData !== false && !state.isEdit) {
    setState({
      ...
      education: editData.data.education,
      totalMarks: editData.data.totalMarks,
      birthdate: editData.data.birthdate,
      gender: editData.data.gender,
      passingOutYear: editData.data.passingOutYear,
      password: editData.data.password,
    })
  }
  ...
  const onFinish = () => {
    ...
    dispatch(updateAccount(student, id));
