...
import { registration } from '../../../store/action/index';
...
const Register = () => {
  ...
  useSelector((state) => {
    if (state && state.authReducer && state.authReducer.currnetuser && isLoading) {
      setIsloading(false);
      history.push('/');
    }
  });
  ...
  const collegeData = useSelector((state) => state.colleges.colleges);
  ...
  const onRegister = (type) => {
    ...
    const studentData = {
      ...
      if(accountType==="student") {
        dispatch(registration(email,password, studentData, type))
      }
      else if (accountType==="company") {
        dispatch(registration(companyEmail,companyPassword, companyData, type))
      }
    ;
  };
        ...
        <Loader />
          ...
          <div className={classes.Register}>
            <div className={classes.registeBox}>
              ...
              {accountType === 'student' ? (
                <Form className={classes.registerForm} onFinish={() => { onRegister(accountType) }}>
